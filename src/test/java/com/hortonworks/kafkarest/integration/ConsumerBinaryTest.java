...
public class ConsumerBinaryTest extends AbstractConsumerTest {
  ...
  public void testInvalidKafkaConsumerConfig() {
    ...
    com.hortonworks.kafkarest.TestUtils.assertErrorResponse(ConstraintViolationExceptionMapper.UNPROCESSABLE_ENTITY, response,
  ...
  public void testDuplicateConsumerID() {
    ...
    com.hortonworks.kafkarest.TestUtils.assertErrorResponse(Response.Status.CONFLICT, createResponse,
