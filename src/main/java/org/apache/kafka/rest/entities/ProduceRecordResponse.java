...
public class ProduceRecordResponse {
    ...
    @JsonCreator
    public ProduceRecordResponse(@JsonProperty("partition") Integer partition,
    ...
    public boolean equals(Object o) {
        ...
        ProduceRecordResponse that = (ProduceRecordResponse) o;
