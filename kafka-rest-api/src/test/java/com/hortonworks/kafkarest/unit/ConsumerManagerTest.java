...
import com.hortonworks.kafkarest.mock.MockConsumerConnector;
import com.hortonworks.kafkarest.mock.MockTime;
...
public class ConsumerManagerTest {
  ...
  public void testDuplicateConsumerName() {
    ...
    try {
      ...
      // expected
      Assert.assertEquals(Errors.CONSUMER_ALREADY_EXISTS_ERROR_CODE, e.getErrorCode());
    }
